...
class Validator {
     ...
     * @param {string} source body, query, or param
     ...
     * @returns {Validator}
     */
    constructor( key, value, source, koa_this, options ) {
    ...
    optional( default_value ) {
        ...
        if ( this.move_on === true ) {
            if ( isUndefined( this.value ) === true ) {
                this.source[ this.key ] = default_value;
                this.move_on = false;
            }
        }
    ...
    isInteger( options ) {
        ...
        if ( this.move_on === true ) {
            ...
            if ( isInteger( this.value, options ) !== true ) {
                ...
                this.source[ this.key ] = parseInt( this.value, 10 );
            }
        }
